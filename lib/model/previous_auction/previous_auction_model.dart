...
part 'previous_auction_model.g.dart';

@JsonSerializable()
class PreviousAuctionModel {
  final bool success;
  @JsonKey(name: 'data')
  ...
  factory PreviousAuctionModel.fromJson(Map<String, dynamic> json) =>
      _$PreviousAuctionModelFromJson(json);

  Map<String, dynamic> toJson() => _$PreviousAuctionModelToJson(this);
}
...
class AuctionData {
  ...
  // final String? fileTerms; // Nullable
  ...
  final int? targetAmountInd; // Nullable
  ...
  final int? targetAmount; // Nullable
