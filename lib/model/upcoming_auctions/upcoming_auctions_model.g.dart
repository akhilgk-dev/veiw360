...
part of 'upcoming_auctions_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

UpcomingAuctionResponse _$UpcomingAuctionResponseFromJson(
...
Map<String, dynamic> _$UpcomingAuctionResponseToJson(
  UpcomingAuctionResponse instance,
) => <String, dynamic>{
...
AuctionData _$AuctionDataFromJson(Map<String, dynamic> json) => AuctionData(
  ...
  mask: json['mask'],
  class_: json['class'],
  startAmount: (json['start_amount'] as num?)?.toInt(),
  ...
  isGrouped: (json['is_grouped'] as num?)?.toInt(),
  ...
  auctionsCount: (json['auctions_count'] as num?)?.toInt(),
  registartionStatus: json['registartion_status'] as String?,
  myRank: json['my_rank'],
  daysRemaining: (json['days_remaining'] as num?)?.toInt(),
  winnerFile: json['winner_file'] as bool?,
  ...
  firstAuctionId: (json['first_auction_id'] as num?)?.toInt(),
  ...
  fileAdditionalInformation: json['file_additional_information'] as bool?,
  clientPaidAmount: (json['client_paid_amount'] as num?)?.toInt(),
  approveStatus: json['approve_status'],
  rejectedDate: json['rejected_date'],
  approvedBy: json['approved_by'],
  approvedDate: json['approved_date'],
  targetAmount: json['target_amount'] as String?,
  autoBidIncrement: (json['auto_bid_increment'] as num?)?.toInt(),
  enabledAutoBidding: json['enabled_auto_bidding'] as bool?,
  fileApprovedDoc: json['file_approved_doc'] as bool?,
  fileReauctionDoc: json['file_reauction_doc'] as bool?,
  ...
  withdrawnAmountClient: (json['withdrawn_amount_client'] as num?)?.toInt(),
...
Map<String, dynamic> _$AuctionDataToJson(AuctionData instance) =>
    <String, dynamic>{
      ...
      'winner_file': instance.winnerFile,
      ...
      'file_approved_doc': instance.fileApprovedDoc,
      'file_reauction_doc': instance.fileReauctionDoc,
...
CategoryDetails _$CategoryDetailsFromJson(Map<String, dynamic> json) =>
    CategoryDetails(
      ...
      isNumber: (json['isNumber'] as num?)?.toInt(),
...
GroupInfo _$GroupInfoFromJson(Map<String, dynamic> json) => GroupInfo(
  ...
  terms: json['terms'] as String?,
  termsArabic: json['terms_arabic'] as String?,
  fileTerms: json['file_terms'] as String?,
  filePaymentTerms: json['file_payment_terms'] as String?,
  ...
  isExtraTime: (json['is_extra_time'] as num?)?.toInt(),
  isVatIncluded: (json['is_vat_included'] as num?)?.toInt(),
  isServiceChargeIncluded: (json['is_service_charge_included'] as num?)
      ?.toInt(),
  isServiceChargeVatIncluded: (json['is_service_charge_vat_included'] as num?)
