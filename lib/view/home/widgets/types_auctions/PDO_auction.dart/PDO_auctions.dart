...
import '../active_auctions/list_widgets.dart';

class PdoAuctions extends ConsumerWidget {
  const PdoAuctions({super.key, required this.title, this.isToday = false});
  final String title;
  final bool isToday;
  @override
    ...
    return activity.when(
      ...
      data: (auctionResponse) {
        ...
        if (filteredAuctions.isEmpty) {
          return isToday ? SizedBox() : SizedBox();
        }
        return Container(
